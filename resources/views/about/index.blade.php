...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-xl text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
                    Dedicated to providing exceptional primary care services with compassion, expertise, and a commitment to your health and well-being.
                </p>
            </div>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-lg text-gray-700 dark:text-gray-300 mb-6">
                        At Primary Care Clinic, we believe that everyone deserves access to high-quality, personalized healthcare. Our mission is to provide comprehensive primary care services that promote health, prevent illness, and support our community's well-being.
                    </p>
                    <p class="text-lg text-gray-700 dark:text-gray-300 mb-8">
                        We are committed to building lasting relationships with our patients, understanding their unique health needs, and working together to achieve optimal health outcomes.
                    </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700 dark:text-gray-300">We put our patients first in everything we do.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700 dark:text-gray-300">Committed to the highest standards of medical care.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700 dark:text-gray-300">Embracing new technologies and treatment approaches.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700 dark:text-gray-300">Serving and supporting our local community.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="relative">
                    <div class="absolute inset-0 bg-gradient-to-r from-blue-400 to-purple-500 rounded-2xl transform rotate-3"></div>
                    <div class="relative bg-white dark:bg-dark-surface rounded-2xl p-8 shadow-2xl">
                        ...
                        <div class="mt-6 text-center">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-dark-text mb-2">Our Team</h3>
                            <p class="text-gray-700 dark:text-gray-300">Dedicated healthcare professionals committed to your health</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="py-16 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-dark-text mb-4">Our Story</h2>
                <p class="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
                    Founded with a vision to provide accessible, high-quality healthcare to our community.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-dark-text mb-2">2018</h3>
                    <p class="text-gray-700 dark:text-gray-300">Founded with a small team of dedicated healthcare professionals</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-dark-text mb-2">2020</h3>
                    <p class="text-gray-700 dark:text-gray-300">Expanded services and added telehealth capabilities</p>
                </div>
                ...
                <div class="text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-dark-text mb-2">2024</h3>
                    <p class="text-gray-700 dark:text-gray-300">Leading primary care provider serving thousands of patients</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 bg-white dark:bg-dark-bg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-dark-text mb-4">Our Services</h2>
                <p class="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
                    Comprehensive primary care services designed to meet all your healthcare needs.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="card text-center group hover:shadow-2xl transition-all duration-300">
                    <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                        <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20">
                            <path fill-rule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd" />
                        </svg>
                    </div>
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-dark-text mb-2">{{ $service->title }}</h3>
                    <p class="text-sm text-gray-700 dark:text-gray-300">{{ Str::limit($service->description, 100) }}</p>
                </div>
                @endforeach
            </div>
        </div>
    ...
    <section class="py-16 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h2 class="text-3xl font-bold text-gray-900 dark:text-dark-text mb-4">Meet Our Team</h2>
                <p class="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
                    Our experienced healthcare professionals are dedicated to providing you with the best possible care.
                </p>
            </div>
