...
<body class="font-sans antialiased bg-white dark:bg-dark-bg text-gray-900 dark:text-dark-text">
    ...
    <!-- Header -->
    <header class="sticky top-0 z-50 bg-white/95 dark:bg-dark-bg/95 backdrop-blur-sm border-b border-gray-200 dark:border-dark-surface">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button id="accessibility-toggle" class="p-2 text-gray-900 dark:text-dark-text hover:text-blue-600 dark:hover:text-blue-400 motion-safe:transition-colors" aria-label="Accessibility options">
                    ...
                    <!-- Theme Toggle -->
                    <button id="theme-toggle" class="p-2 text-gray-900 dark:text-dark-text hover:text-blue-600 dark:hover:text-blue-400 motion-safe:transition-colors" aria-label="Toggle dark mode">
                    ...
                    <!-- Mobile menu button -->
                    <button id="mobile-menu-button" class="md:hidden p-2 text-gray-900 dark:text-dark-text hover:text-blue-600 dark:hover:text-blue-400 motion-safe:transition-colors" aria-label="Toggle mobile menu">
    ...
    <!-- Accessibility Panel -->
    <div id="accessibility-panel" class="hidden fixed top-16 right-4 z-50 bg-white dark:bg-dark-surface rounded-lg shadow-2xl border border-gray-200 dark:border-dark-surface p-4 w-64">
        ...
        <div class="space-y-3">
            <div class="flex items-center justify-between">
                ...
                <button id="high-contrast-toggle" class="relative inline-flex h-6 w-11 items-center rounded-full bg-gray-200 dark:bg-gray-700 transition-colors">
                    <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ease-in-out"></span>
                </button>
            </div>
            <div class="flex items-center justify-between">
                <span class="text-sm text-gray-900 dark:text-dark-text">Large Text</span>
                <button id="large-text-toggle" class="relative inline-flex h-6 w-11 items-center rounded-full bg-gray-200 dark:bg-gray-700 transition-colors">
                    <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ease-in-out"></span>
                </button>
            </div>
            <div class="flex items-center justify-between">
                <span class="text-sm text-gray-900 dark:text-dark-text">Reduced Motion</span>
                <button id="reduced-motion-toggle" class="relative inline-flex h-6 w-11 items-center rounded-full bg-gray-200 dark:bg-gray-700 transition-colors">
                    <span class="inline-block h-4 w-4 transform rounded-full bg-white transition-transform duration-200 ease-in-out"></span>
                </button>
            </div>
        </div>
