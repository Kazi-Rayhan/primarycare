...
<body class="font-sans antialiased bg-white dark:bg-dark-bg text-gray-900 dark:text-dark-text">
            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button id="theme-toggle" class="dark-mode-toggle" aria-label="Toggle dark mode">
                        <span class="dark-mode-toggle-thumb"></span>
                    </button>
    ...
    <script>
        ...
        function updateThemeToggle() {
            ...
            const themeToggleThumb = themeToggle.querySelector('.dark-mode-toggle-thumb');
            if (isDark) {
                themeToggleThumb.style.transform = 'translateX(1.25rem)';
            } else {
